...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4c11;
...
const char     CRYPTONOTE_NAME[]                             = "reichsmarksochia";
...
const int      P2P_DEFAULT_PORT                              = 33333;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 33334;
